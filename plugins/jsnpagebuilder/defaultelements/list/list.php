...
class JSNPBShortcodeList extends IG_Pb_Element {
	...
	public function element_config() {
		...
		$this->config['name']             = JText::_( 'List' );
		$this->config['cat']              = JText::_( 'Typography' );
		$this->config['icon']             = 'icon-list';
		$this->config['description']      = JText::_("List of free content with icons");
		...
		$this->items = array(
			...
			'styling' => array(
				...
				array(
					...
					'tooltip'    => 'Show Icon Description',
					'has_depend' => '1',
				),
				array(
					'name'       => JText::_( 'Icon Position' ),
					'id'         => 'icon_position',
					'type'       => 'select',
					'class'      => 'input-small',
					...
					'tooltip'    => JText::_( 'Icon Position Description' ),
					'dependency' => array( 'show_icon', '=', 'yes' )
				),
				array(
					'name' => JText::_( 'Icon Background' ),
					'type' => array(
						array(
							'id'           => 'icon_size_value',
							'type'         => 'select',
					...
					'tooltip'         => JText::_( 'Icon Background Description' ),
					'container_class' => 'combo-group',
					'dependency'      => array( 'show_icon', '=', 'yes' )
				),
				array(
					'name' => JText::_( 'Icon Color' ),
					'type' => array(
						array(
							'id'           => 'icon_c_value',
							'type'         => 'text_field',
					...
					'tooltip'         => JText::_( 'Icon Color Description' ),
					'container_class' => 'combo-group',
					'dependency'      => array( 'show_icon', '=', 'yes' )
				),
				array(
				...
				array(
					'name'       => JText::_( 'Show Heading' ),
					'id'         => 'show_heading',
					'type'       => 'radio',
					'std'        => 'yes',
					'options'    => array( 'yes' => JText::_( 'Yes' ), 'no' => JText::_( 'No' ) ),
					'tooltip'    => 'Show Heading Description',
					'has_depend' => '1',
				),
				array(
					'name'       => JText::_( 'Heading Font' ),
					'id'         => 'font',
					'type'       => 'select',
					'std'        => 'inherit',
					'options'    => array( 'inherit' => JText::_( 'Inherit' ), 'custom' => JText::_( 'Custom' ) ),
					'has_depend' => '1',
					'tooltip'    => JText::_( 'Heading Font Description' ),
					'class'      => 'input-medium',
