...
class JSNPBShortcodeUniform extends IG_Pb_Element {
    ...
    public function __construct() {
        if (JComponentHelper::isInstalled('com_uniform') === 1 && JComponentHelper::isEnabled('com_uniform') === '1') {
    ...
    public function element_config() {
        ...
        $this->config['name'] = JText::_('JSN Uniform');
        $this->config['cat'] = JText::_('Extra');
        $this->config['icon'] = 'icon-pb-uniform';
        $this->config['description'] = JText::_("The most easy, yet sophisticated Joomla form builder extension");
    }
        ...
        $this->items = array(
            'content' => array(
                array(
                    ...
                    'std'   => JText::_('JSN Uniform PB_INDEX_TRICK'),
                    'role'  => 'title',
                ),
                array(
                    'name'    => JText::_('Form'),
    ...
    public function element_shortcode($atts = null, $content = null) {
        ...
        if (JComponentHelper::isInstalled('com_uniform') !== 1 || JComponentHelper::isEnabled('com_uniform') !== '1') {
            $html_element = JText::_('Please install or enable  JSN Uniform Component before use this element');
