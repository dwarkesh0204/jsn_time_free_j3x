...
class JSNPBShortcodeMarket extends IG_Pb_Element
{
    ...
    function element_config()
    {
        ...
        $this->config['name'] = JText::_('Market');
        $this->config['cat'] = JText::_('Extra');
        $this->config['icon'] = "icon-market";
        $this->config['has_subshortcode'] = __CLASS__ . 'Item';
        $this->config['description'] = JText::_("Display Stock Information of companies");

        $this->config['exception'] = array(
            'default_content' => JText::_('Market')
        );
    }
        ...
        $this->items = array(
            'content' => array(
                array(
                    ...
                    "std"     => JText::_('Sample market PB_INDEX_TRICK'),
                    "role"    => "title",
                ...
                array(
                    ...
                    "type"    => "text_field",
                    "class"   => "jsn-input-xxlarge-fluid",
                    "std"     => JText::_('Yahoo Market'),
                ),
                array(
                    'id'            => 'market_items',
                    'name'          => JText::_('Market Items'),
                    'type'          => 'group',
                    ...
                    'label_item'    => JText::_('Market Item'),
                ),
            ),
            'styling' => array(
                array(
                ...
                array(
                    ...
                    'options'    => array(
                        self::PB_MARKET_TABLE_LAYOUT    => JText::_('Table'),
                        self::PB_MARKET_CAROUSEL_LAYOUT => JText::_('Carousel'),
                    ),
                    'has_depend' => '1'
                ),
                array(
                    'name'       => JText::_('Slide dimension'),
                ...
                array(
                    'name'       => JText::_('Show carousel control'),
                ...
                array(
                    'name'       => JText::_('Carousel auto play'),
