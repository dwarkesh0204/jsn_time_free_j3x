...
<div class="jsn-article-layout">
	...
	<?php if(!empty($item->fulltext)){ ?>
		<?php $_showIntroClass = $item->params->get('itemIntroText') ? 'display-default display-item' : 'hide-item'; ?>
	<div class="item-intro element-switch  contextmenu-approved <?php echo $_showIntroClass?>" id="itemIntroText">
  		<?php echo $item->introtext; ?>
	</div>
		<?php $_showFulltextClass = $item->params->get('itemFullText') ? 'display-default display-item' : 'hide-item'; ?>
	<div class="item-fulltext element-switch  contextmenu-approved <?php echo $_showFulltextClass?>" id="itemFullText">
