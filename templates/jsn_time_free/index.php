...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	if (($this->helper->countPositions('top')) || (isset($this->socialIcons) AND count($this->socialIcons))) {
	?>
		<div id="header">
		<div id="header-inner">
				...
				?>
					<div id="jsn-switch-mode" class="pull-right">
						<span id="jsn-desktopswitch">
							<a href="#" onclick="javascript: JSNUtils.setTemplateAttribute('<?php echo $this->templatePrefix ?>','mobile','no'); return false;"><i class="jsn-icon-monitor"></i></a>
						</span>
						<span id="jsn-mobileswitch">
							<a href="#" onclick="javascript: JSNUtils.setTemplateAttribute('<?php echo $this->templatePrefix ?>','mobile','yes'); return false;"><i class="jsn-icon-mobile"></i></a>
						</span>
					</div>
